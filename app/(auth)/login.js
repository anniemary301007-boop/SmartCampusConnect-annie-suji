...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.success) {
        // Remove password before storing/using user object
          ...
          <Animated.View style={{opacity:fadeAnim}}>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.inputBox}>
                ...
                <TextInput placeholder="Enter Email" placeholderTextColor="#888" style={styles.input} value={email} onChangeText={setEmail}/>
              </View>

              <View style={styles.inputBox}>
                <Ionicons name="lock-closed-outline" size={20} color="#555"/>
                <TextInput placeholder="Enter Password" placeholderTextColor="#888" secureTextEntry style={styles.input} value={password} onChangeText={setPassword}/>
              </View>
              ...
              <Text style={styles.signupLine}>
                ...
                <Text style={styles.signupLink} onPress={()=>router.push("/(auth)/register")}>Sign Up</Text>{" "}
...
const styles = StyleSheet.create({
  ...
  appSubtitle:{color:"#E0E7FF",marginTop:6},
  card:{backgroundColor:"#fff",padding:25,borderRadius:20,elevation:8},
  loginTitle:{fontSize:22,fontWeight:"bold",textAlign:"center",marginBottom:20},
  inputBox:{flexDirection:"row",alignItems:"center",backgroundColor:"#F3F4F6",padding:12,borderRadius:10,marginBottom:15},
  input:{flex:1,marginLeft:10},
  loginBtn:{backgroundColor:"#2563EB",padding:14,borderRadius:10,alignItems:"center",marginTop:10},
  loginText:{color:"#fff",fontSize:16,fontWeight:"bold"},
  signupLine:{textAlign:"center",marginTop:15,color:"#555",fontSize:14},
